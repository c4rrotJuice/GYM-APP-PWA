...
TEST_FILE="$ROOT_DIR/supabase/tests/phase3_financial_verification.sql"

echo "Running Phase 3.3 financial RLS verification suite..."
...
echo "PASS - Phase 3.3 financial RLS verification suite completed."
