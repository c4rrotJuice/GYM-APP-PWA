...
const ROLE_CAPABILITIES = Object.freeze({
  [ROLES.ADMIN]: [
    ...
    'memberships:suspend',
    'membership_expiry:process',
    'membership_expiry:summary',
  ...
  [ROLES.TRAINER]: [
    ...
    'attendance:manual_log_assigned',
    'members:view',
...
export const ACTION_PERMISSIONS = Object.freeze({
  ...
  'memberships:suspend': ['memberships:suspend'],
  'memberships:reactivate': ['memberships:suspend'],
  'membership_expiry:process': ['membership_expiry:process'],
  'membership_expiry:summary': ['membership_expiry:summary'],
  'attendance:eligibility': ['attendance:eligibility'],
  'attendance:manual_log': ['attendance:manual_log', 'attendance:manual_log_assigned'],
  'membership_history:list': ['memberships:view_all', 'memberships:view_assigned', 'memberships:view_own'],
